package com.example.maobuidinh.realm.activity;
...
import com.example.maobuidinh.realm.adapter.BookAdapter;
import com.example.maobuidinh.realm.adapter.RealmBookAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!PrefManager.with(this).getPreLoad()) {
            setRealmData();
        }
    ...
    private void setRealmData() {
        ...
        book.setImageUrl("https://raw.githubusercontent.com/maobui/AndroidStudio/master/Realm/asset/1.png");
        books.add(book);
        ...
        book.setImageUrl("https://raw.githubusercontent.com/maobui/AndroidStudio/master/Realm/asset/2.png");
        books.add(book);
        ...
        book.setImageUrl("https://raw.githubusercontent.com/maobui/AndroidStudio/master/Realm/asset/3.png");
        books.add(book);
        ...
        book.setImageUrl("https://raw.githubusercontent.com/maobui/AndroidStudio/master/Realm/asset/4.png");
        books.add(book);
        ...
        book.setImageUrl("https://raw.githubusercontent.com/maobui/AndroidStudio/master/Realm/asset/5.png");
        books.add(book);
