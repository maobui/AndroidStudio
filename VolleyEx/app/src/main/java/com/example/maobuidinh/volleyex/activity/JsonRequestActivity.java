...
public class JsonRequestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void makeJsonObjReq() {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                AppConstant.URL_PERSON_OBJECT, null,
    ...
    private void makeJsonArryReq() {
        showProgressDialog();
        JsonArrayRequest req = new JsonArrayRequest(AppConstant.URL_PERSON_ARRAY,
        ...
        // Adding request to request queue
        AppController.getInstance().addToRequestqQueue(req,
                tag_json_arry);
