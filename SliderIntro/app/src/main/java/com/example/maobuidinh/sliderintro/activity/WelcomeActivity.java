...
import com.example.maobuidinh.sliderintro.adapter.WelcomeViewPagerAdapter;
...
public class WelcomeActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        mWelcomeViewPagerAdapter = new WelcomeViewPagerAdapter(this, layouts);
    ...
    private void addBottomDots(int currentPage) {
        ...
        for (int i = 0; i < dots.length; i++) {
            ...
            // dot text from HMTL code = "&bull;" or "&#8226;"
    ...
    private void launchHomeScreen() {
        PrefManager.getInstance(this).setFirstTimeLaunch(false);
