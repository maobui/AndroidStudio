package com.example.maobuidinh.inappbrowser;
...
/**
 * Created by maobuidinh on 6/8/2017.
 */
...
public class Utils {
    ...
    public static void bookmarkUrl(Context context, String url) {
        SharedPreferences pref = context.getSharedPreferences("InAppBrowser", 0); // 0 - for private mode
    ...
    public static boolean isBookmarked(Context context, String url) {
        SharedPreferences pref = context.getSharedPreferences("InAppBrowser", 0);
